...
VL_INLINE_OPT void VALU32Bit::_sequent__TOP__1(VALU32Bit__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32Bit::_sequent__TOP__1\n"); );
    VALU32Bit* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VALU32Bit::_settle__TOP__2(VALU32Bit__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32Bit::_settle__TOP__2\n"); );
    VALU32Bit* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at ALU32Bit.v:164
    vlTOPp->Zero = (0U == vlTOPp->ALUResult);
