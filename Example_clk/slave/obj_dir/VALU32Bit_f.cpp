...
// See VALU32Bit_f.h for the primary calling header

#include "VALU32Bit_f.h"       // For This
#include "VALU32Bit_f__Syms.h"
...
VL_CTOR_IMP(VALU32Bit_f) {
    VALU32Bit_f__Syms* __restrict vlSymsp = __VlSymsp = new VALU32Bit_f__Syms(this, name());
    VALU32Bit_f* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VALU32Bit_f::__Vconfigure(VALU32Bit_f__Syms* vlSymsp, bool first) {
    if (0 && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
}

VALU32Bit_f::~VALU32Bit_f() {
...
void VALU32Bit_f::eval() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate VALU32Bit_f::eval\n"); );
    VALU32Bit_f__Syms* __restrict vlSymsp = this->__VlSymsp;  // Setup global symbol table
    VALU32Bit_f* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
#ifdef VL_DEBUG
    // Debug assertions
...
void VALU32Bit_f::_eval_initial_loop(VALU32Bit_f__Syms* __restrict vlSymsp) {
...
VL_INLINE_OPT void VALU32Bit_f::_sequent__TOP__1(VALU32Bit_f__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32Bit_f::_sequent__TOP__1\n"); );
    VALU32Bit_f* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at ALU32Bit_f.v:52
    ...
    // ALWAYS at ALU32Bit_f.v:164
    vlTOPp->Zero = (0U == vlTOPp->ALUResult);
}

void VALU32Bit_f::_settle__TOP__2(VALU32Bit_f__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32Bit_f::_settle__TOP__2\n"); );
    VALU32Bit_f* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at ALU32Bit_f.v:164
    vlTOPp->Zero = (0U == vlTOPp->ALUResult);
...
void VALU32Bit_f::_eval(VALU32Bit_f__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32Bit_f::_eval\n"); );
    VALU32Bit_f* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VALU32Bit_f::_eval_initial(VALU32Bit_f__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32Bit_f::_eval_initial\n"); );
    VALU32Bit_f* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
}

void VALU32Bit_f::final() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32Bit_f::final\n"); );
    // Variables
    VALU32Bit_f__Syms* __restrict vlSymsp = this->__VlSymsp;
    VALU32Bit_f* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
}

void VALU32Bit_f::_eval_settle(VALU32Bit_f__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32Bit_f::_eval_settle\n"); );
    VALU32Bit_f* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->_settle__TOP__2(vlSymsp);
}

VL_INLINE_OPT QData VALU32Bit_f::_change_request(VALU32Bit_f__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32Bit_f::_change_request\n"); );
    VALU32Bit_f* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
...
#ifdef VL_DEBUG
void VALU32Bit_f::_eval_debug_assertions() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32Bit_f::_eval_debug_assertions\n"); );
    // Body
...
void VALU32Bit_f::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32Bit_f::_ctor_var_reset\n"); );
    // Body
