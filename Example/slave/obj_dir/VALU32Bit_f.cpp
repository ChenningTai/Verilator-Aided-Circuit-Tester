...
VL_INLINE_OPT void VALU32Bit_f::_combo__TOP__1(VALU32Bit_f__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32Bit_f::_combo__TOP__1\n"); );
    VALU32Bit_f* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at ALU32Bit_f.v:51
