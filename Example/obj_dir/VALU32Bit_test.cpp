...
void VALU32Bit_test::_settle__TOP__2(VALU32Bit_test__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VALU32Bit_test::_settle__TOP__2\n"); );
    VALU32Bit_test* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at ALU32Bit.v:51
    if (((((((((0U == (IData)(vlTOPp->ALUControl)) 
